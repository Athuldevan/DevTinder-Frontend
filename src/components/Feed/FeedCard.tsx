        ...
        <div className="card-body p-8">
          <div className="text-center mb-6">
            ...
            <div className="flex justify-center items-center gap-4 text-sm text-gray-300">
              <span className="bg-gray-800 px-3 py-1 rounded-full border border-gray-700">{user?.age || "N/A"} years</span>
              <span>•</span>
          ...
          {user.skills && user.skills.length > 0 && (
            <div className="mb-6">
              <h3 className="font-semibold text-white mb-3 text-center text-sm uppercase tracking-wide">Expertise</h3>
